      ...
      if (!label || oldValue == label) {
        ...
        Polymer({
            ...
            _add_row : function(event){
                ...
                // remove it
                this.splice('items', index , 0,''+event.model.item);
                
                // items changed,but still,dom is not ready until at this end of microtask.
                // dom creation is queue in debounce/async callbacks.
                // so queue animation after it.
                var self = this;
                this.async(function(){
                    self._playItemAddAnimation(index);
                });
            },
            ...
            _itemsChanged : function(event){
                var items = this.get('items');
                this.set('_removable',items.length > 1);
            },
            ...
            _playItemAddAnimation : function(index){
                ...
                this.debounce(animation_key,function(){
                    var animactions = [];
                    self.get('items').forEach(function(item,trace_index){
                    ...
                    self.animationConfig[animation_key] = animactions;
            ...
            _playItemRemoveAnimation : function(index){
                ...
                this.debounce(animation_key,function(){
                    var animactions = [];
                    for(var trace_index = 0; trace_index< self.$.container.children.length - 1; trace_index++){
                        if(trace_index > index){
                            animactions.push({
...
(function() {
  ...
  PaperToast.currentToast = null;
        ...
        Polymer({
            ...
            ready : function(){
                this._doc = Polymer.DomApi. getLightChildren(this)[0].data;
                this.playActiveAnimation();
            },
            
            playActiveAnimation : function(){
                this._playSomeAnimation('doc','slide-down-animation');
